...
while True:
    ...
    if num.isnumeric() == True: #проверка что ввели число
        num=int(num)
        break
    else:
        print("Это не правильный ввод. Это не число, попробуйте еще раз.")
...
def binary_search(array, element, left=0, right=len(list_of_numbers)-1):
...
print('номер позиции элемента, который меньше введенного числа:',binary_search(list_of_numbers, num))